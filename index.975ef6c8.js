...
refs.input.addEventListener("input", (0, _lodashDebounceDefault.default)(getCountry, DEBOUNCE_DELAY));
function getCountry(event) {
    ...
    const promise = (0, _fetchCountries.fetchCountries)(searchQuery);
    promise.then((response)=>{
        if (response.status === 404) throw new Error("Network response was not ok");
        return response;
    }).then((countries)=>{
        if (countries.length > 10) {
            (0, _notiflix.Notify).warning("Too many matches found. Please enter a more specific name.");
            refs.countryList.innerHTML = "";
            refs.countryInfo.innerHTML = "";
...
},{"./fetchCountries":"fTQqv","./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5z0Oc"}],"fTQqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequireabb0")
